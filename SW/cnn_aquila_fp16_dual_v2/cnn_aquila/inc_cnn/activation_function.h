...
// static inline my_float_t identity(my_float_t *arr, int index, int out_dim)
// {
//     // return arr[index];
...
// static inline my_float_t relu(my_float_t *arr, int index, int out_dim)
// {
...
static inline my_float_t bounded_relu(my_float_t *arr, int index, int out_dim)
{
...
// old softmax
//
// static inline my_float_t softmax(my_float_t *arr, int index, int out_dim)
// {
//     my_float_t max = 0;
